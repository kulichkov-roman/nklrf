...
namespace Your\Service\Tools\Token;

use Your\Common\SingletonInterface;
use Your\Exception\Token\BreakingException;
use Your\Exception\Token\ExpiredException;
use Your\Exception\Token\NotFoundException;
use Your\Tools\Token\Action;
use Your\Tools\Token\ActionFactory;
use Your\Tools\Token\GenerationAlgorithm\AlgorithmInterface;
use Your\Tools\Token\RepositoryInterface;
use Your\Tools\Token\Token;
use Your\Tools\Token\TokenRepository;
 ...
 *
 * @package Your\Service\Tools\Token
 */
class TokenActionService implements SingletonInterface
{
	...
	public function generateToken(
		...
		if (!self::isSubclassOf($actionClass, 'Your\Tools\Token\Action')) {
			throw new \RuntimeException('Action class must be derived from "Your\Tools\Token\Action"');
		}
